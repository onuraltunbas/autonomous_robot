...
webots_ros2_msgs__msg__FloatStamped__create(void)
{
...
webots_ros2_msgs__msg__FloatStamped__Sequence__init(webots_ros2_msgs__msg__FloatStamped__Sequence * array, size_t size)
{
  ...
  if (size) {
    if (size > SIZE_MAX / sizeof(webots_ros2_msgs__msg__FloatStamped)) {
      return false;
    }
  ...
  webots_ros2_msgs__msg__FloatStamped__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    if (input->size > SIZE_MAX / sizeof(webots_ros2_msgs__msg__FloatStamped)) {
      return false;
    }
