...
template<typename T, std::enable_if_t<std::is_same_v<std::decay_t<T>, webots_ros2_msgs::msg::CameraRecognitionObject>, int> = 0>
constexpr auto as_tuple_ref(T && msg)
{
  return std::forward_as_tuple(
    std::forward<T>(msg).id,
    std::forward<T>(msg).pose,
    std::forward<T>(msg).bbox,
    std::forward<T>(msg).colors,
    std::forward<T>(msg).model);
}
...
template<>
constexpr const char * data_type<webots_ros2_msgs::msg::CameraRecognitionObject>()
{
  return "webots_ros2_msgs::msg::CameraRecognitionObject";
}

template<>
constexpr const char * name<webots_ros2_msgs::msg::CameraRecognitionObject>()
{
  return "webots_ros2_msgs/msg/CameraRecognitionObject";
}
...
template<>
struct MessageTraits<webots_ros2_msgs::msg::CameraRecognitionObject>
{
