...
template<typename T, std::enable_if_t<std::is_same_v<std::decay_t<T>, webots_ros2_msgs::msg::BoolStamped>, int> = 0>
...
template<>
constexpr const char * data_type<webots_ros2_msgs::msg::BoolStamped>()
{
  return "webots_ros2_msgs::msg::BoolStamped";
}

template<>
constexpr const char * name<webots_ros2_msgs::msg::BoolStamped>()
{
  return "webots_ros2_msgs/msg/BoolStamped";
}
...
template<>
struct MessageTraits<webots_ros2_msgs::msg::BoolStamped>
{
