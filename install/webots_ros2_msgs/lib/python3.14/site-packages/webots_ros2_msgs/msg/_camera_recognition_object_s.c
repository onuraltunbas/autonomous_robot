...
bool webots_ros2_msgs__msg__camera_recognition_object__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("webots_ros2_msgs.msg._camera_recognition_object", (char *)PyUnicode_1BYTE_DATA(module_attr), 47) == 0);
    assert(strncmp("CameraRecognitionObject", (char *)PyUnicode_1BYTE_DATA(name_attr), 23) == 0);
