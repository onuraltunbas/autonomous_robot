...
class Metaclass_StringStamped(rosidl_pycommon.interface_base_classes.MessageTypeSupportMeta):
    ...
    class StringStampedConstants(typing.TypedDict):
        pass

    __constants: StringStampedConstants = {
    }
    ...
    def __import_type_support__(cls) -> None:
        try:
            ...
            logger = logging.getLogger(
                'webots_ros2_msgs.msg.StringStamped')
            logger.debug(
...
class StringStamped(rosidl_pycommon.interface_base_classes.BaseMessage, metaclass=Metaclass_StringStamped):
    ...
    def __init__(self, *,
                 ...
                 data: typing.Optional[str] = None,  # noqa: E501
        ...
        self.data = data if data is not None else str()
    ...
    def __eq__(self, other: object) -> bool:
        if not isinstance(other, StringStamped):
            return False
