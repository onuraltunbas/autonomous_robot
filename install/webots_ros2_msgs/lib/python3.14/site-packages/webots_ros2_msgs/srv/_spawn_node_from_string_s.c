...
bool webots_ros2_msgs__srv__spawn_node_from_string__request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("webots_ros2_msgs.srv._spawn_node_from_string", (char *)PyUnicode_1BYTE_DATA(module_attr), 44) == 0);
    assert(strncmp("SpawnNodeFromString_Request", (char *)PyUnicode_1BYTE_DATA(name_attr), 27) == 0);
...
bool webots_ros2_msgs__srv__spawn_node_from_string__response__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    // PyUnicode_1BYTE_DATA is just a cast
    assert(strncmp("webots_ros2_msgs.srv._spawn_node_from_string", (char *)PyUnicode_1BYTE_DATA(module_attr), 44) == 0);
    assert(strncmp("SpawnNodeFromString_Response", (char *)PyUnicode_1BYTE_DATA(name_attr), 28) == 0);
...
bool webots_ros2_msgs__srv__spawn_node_from_string__event__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    // PyUnicode_1BYTE_DATA is just a cast
    assert(strncmp("webots_ros2_msgs.srv._spawn_node_from_string", (char *)PyUnicode_1BYTE_DATA(module_attr), 44) == 0);
    assert(strncmp("SpawnNodeFromString_Event", (char *)PyUnicode_1BYTE_DATA(name_attr), 25) == 0);
