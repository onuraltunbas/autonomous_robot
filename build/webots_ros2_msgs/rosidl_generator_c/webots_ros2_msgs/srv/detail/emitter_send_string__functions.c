...
webots_ros2_msgs__srv__EmitterSendString_Request__create(void)
{
...
webots_ros2_msgs__srv__EmitterSendString_Request__Sequence__init(webots_ros2_msgs__srv__EmitterSendString_Request__Sequence * array, size_t size)
{
  ...
  if (size) {
    if (size > SIZE_MAX / sizeof(webots_ros2_msgs__srv__EmitterSendString_Request)) {
      return false;
    }
  ...
  webots_ros2_msgs__srv__EmitterSendString_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    if (input->size > SIZE_MAX / sizeof(webots_ros2_msgs__srv__EmitterSendString_Request)) {
      return false;
    }
...
webots_ros2_msgs__srv__EmitterSendString_Response__create(void)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
...
webots_ros2_msgs__srv__EmitterSendString_Response__Sequence__init(webots_ros2_msgs__srv__EmitterSendString_Response__Sequence * array, size_t size)
{
  ...
  if (size) {
    if (size > SIZE_MAX / sizeof(webots_ros2_msgs__srv__EmitterSendString_Response)) {
      return false;
    }
  ...
  webots_ros2_msgs__srv__EmitterSendString_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    if (input->size > SIZE_MAX / sizeof(webots_ros2_msgs__srv__EmitterSendString_Response)) {
      return false;
    }
    const size_t allocation_size =
...
bool
webots_ros2_msgs__srv__EmitterSendString_Event__init(webots_ros2_msgs__srv__EmitterSendString_Event * msg)
{
  if (!msg) {
    return false;
  }
  ...
  if (!service_msgs__msg__ServiceEventInfo__init(&msg->info)) {
    webots_ros2_msgs__srv__EmitterSendString_Event__fini(msg);
    return false;
  }
  // request
  if (!webots_ros2_msgs__srv__EmitterSendString_Request__Sequence__init(&msg->request, 0)) {
    webots_ros2_msgs__srv__EmitterSendString_Event__fini(msg);
    return false;
  }
  // response
  if (!webots_ros2_msgs__srv__EmitterSendString_Response__Sequence__init(&msg->response, 0)) {
    webots_ros2_msgs__srv__EmitterSendString_Event__fini(msg);
    return false;
  }
  return true;
...
void
webots_ros2_msgs__srv__EmitterSendString_Event__fini(webots_ros2_msgs__srv__EmitterSendString_Event * msg)
{
  if (!msg) {
    return;
  }
  ...
  // request
  webots_ros2_msgs__srv__EmitterSendString_Request__Sequence__fini(&msg->request);
  // response
  webots_ros2_msgs__srv__EmitterSendString_Response__Sequence__fini(&msg->response);
}

bool
webots_ros2_msgs__srv__EmitterSendString_Event__are_equal(const webots_ros2_msgs__srv__EmitterSendString_Event * lhs, const webots_ros2_msgs__srv__EmitterSendString_Event * rhs)
{
  if (!lhs || !rhs) {
    return false;
  }
  ...
  // request
  if (!webots_ros2_msgs__srv__EmitterSendString_Request__Sequence__are_equal(
      &(lhs->request), &(rhs->request)))
  {
    return false;
  }
  // response
  if (!webots_ros2_msgs__srv__EmitterSendString_Response__Sequence__are_equal(
...
bool
webots_ros2_msgs__srv__EmitterSendString_Event__copy(
  const webots_ros2_msgs__srv__EmitterSendString_Event * input,
  webots_ros2_msgs__srv__EmitterSendString_Event * output)
{
  if (!input || !output) {
    return false;
  }
  ...
  // request
  if (!webots_ros2_msgs__srv__EmitterSendString_Request__Sequence__copy(
      &(input->request), &(output->request)))
  {
    return false;
  }
  // response
  if (!webots_ros2_msgs__srv__EmitterSendString_Response__Sequence__copy(
...
webots_ros2_msgs__srv__EmitterSendString_Event *
webots_ros2_msgs__srv__EmitterSendString_Event__create(void)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  webots_ros2_msgs__srv__EmitterSendString_Event * msg = (webots_ros2_msgs__srv__EmitterSendString_Event *)allocator.allocate(sizeof(webots_ros2_msgs__srv__EmitterSendString_Event), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(webots_ros2_msgs__srv__EmitterSendString_Event));
  bool success = webots_ros2_msgs__srv__EmitterSendString_Event__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
void
webots_ros2_msgs__srv__EmitterSendString_Event__destroy(webots_ros2_msgs__srv__EmitterSendString_Event * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    webots_ros2_msgs__srv__EmitterSendString_Event__fini(msg);
...
bool
webots_ros2_msgs__srv__EmitterSendString_Event__Sequence__init(webots_ros2_msgs__srv__EmitterSendString_Event__Sequence * array, size_t size)
{
  if (!array) {
    return false;
  }
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  webots_ros2_msgs__srv__EmitterSendString_Event * data = NULL;

  if (size) {
    if (size > SIZE_MAX / sizeof(webots_ros2_msgs__srv__EmitterSendString_Event)) {
      return false;
    }
    data = (webots_ros2_msgs__srv__EmitterSendString_Event *)allocator.zero_allocate(size, sizeof(webots_ros2_msgs__srv__EmitterSendString_Event), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = webots_ros2_msgs__srv__EmitterSendString_Event__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        webots_ros2_msgs__srv__EmitterSendString_Event__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
void
webots_ros2_msgs__srv__EmitterSendString_Event__Sequence__fini(webots_ros2_msgs__srv__EmitterSendString_Event__Sequence * array)
{
  if (!array) {
    return;
  }
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      webots_ros2_msgs__srv__EmitterSendString_Event__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
webots_ros2_msgs__srv__EmitterSendString_Event__Sequence *
webots_ros2_msgs__srv__EmitterSendString_Event__Sequence__create(size_t size)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  webots_ros2_msgs__srv__EmitterSendString_Event__Sequence * array = (webots_ros2_msgs__srv__EmitterSendString_Event__Sequence *)allocator.allocate(sizeof(webots_ros2_msgs__srv__EmitterSendString_Event__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = webots_ros2_msgs__srv__EmitterSendString_Event__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
void
webots_ros2_msgs__srv__EmitterSendString_Event__Sequence__destroy(webots_ros2_msgs__srv__EmitterSendString_Event__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    webots_ros2_msgs__srv__EmitterSendString_Event__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}

bool
webots_ros2_msgs__srv__EmitterSendString_Event__Sequence__are_equal(const webots_ros2_msgs__srv__EmitterSendString_Event__Sequence * lhs, const webots_ros2_msgs__srv__EmitterSendString_Event__Sequence * rhs)
{
  if (!lhs || !rhs) {
    return false;
  }
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!webots_ros2_msgs__srv__EmitterSendString_Event__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
...
bool
webots_ros2_msgs__srv__EmitterSendString_Event__Sequence__copy(
  const webots_ros2_msgs__srv__EmitterSendString_Event__Sequence * input,
  webots_ros2_msgs__srv__EmitterSendString_Event__Sequence * output)
{
  if (!input || !output) {
    return false;
  }
  if (output->capacity < input->size) {
    if (input->size > SIZE_MAX / sizeof(webots_ros2_msgs__srv__EmitterSendString_Event)) {
      return false;
    }
    const size_t allocation_size =
      input->size * sizeof(webots_ros2_msgs__srv__EmitterSendString_Event);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    webots_ros2_msgs__srv__EmitterSendString_Event * data =
      (webots_ros2_msgs__srv__EmitterSendString_Event *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!webots_ros2_msgs__srv__EmitterSendString_Event__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          webots_ros2_msgs__srv__EmitterSendString_Event__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!webots_ros2_msgs__srv__EmitterSendString_Event__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
