...
#include "webots_ros2_msgs/msg/detail/camera_recognition_object__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const webots_ros2_msgs::msg::CameraRecognitionObject & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  webots_ros2_msgs::msg::CameraRecognitionObject & ros_message)
{
  // Member: id
  cdr >> ros_message.id;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = webots_ros2_msgs::msg::CameraRecognitionObject;
    is_plain =
      (
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_webots_ros2_msgs
max_serialized_size_key_CameraRecognitionObject(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
{
  auto typed_message =
    static_cast<const webots_ros2_msgs::msg::CameraRecognitionObject *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<webots_ros2_msgs::msg::CameraRecognitionObject *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _CameraRecognitionObject__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const webots_ros2_msgs::msg::CameraRecognitionObject *>(
...
static size_t _CameraRecognitionObject__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_CameraRecognitionObject(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _CameraRecognitionObject__callbacks = {
...
static rosidl_message_type_support_t _CameraRecognitionObject__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_CameraRecognitionObject__callbacks,
...
{
  return &webots_ros2_msgs::msg::typesupport_fastrtps_cpp::_CameraRecognitionObject__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, webots_ros2_msgs, msg, CameraRecognitionObject)() {
  return &webots_ros2_msgs::msg::typesupport_fastrtps_cpp::_CameraRecognitionObject__handle;
}
