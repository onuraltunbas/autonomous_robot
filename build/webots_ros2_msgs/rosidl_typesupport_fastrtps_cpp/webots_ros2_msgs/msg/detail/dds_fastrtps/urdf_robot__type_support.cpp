...
#include "webots_ros2_msgs/msg/detail/urdf_robot__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const webots_ros2_msgs::msg::UrdfRobot & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  cdr << ros_message.robot_description;

  // Member: relative_path_prefix
  cdr << ros_message.relative_path_prefix;
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  webots_ros2_msgs::msg::UrdfRobot & ros_message)
{
  // Member: name
  cdr >> ros_message.name;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = webots_ros2_msgs::msg::UrdfRobot;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const webots_ros2_msgs::msg::UrdfRobot *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<webots_ros2_msgs::msg::UrdfRobot *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _UrdfRobot__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const webots_ros2_msgs::msg::UrdfRobot *>(
...
static size_t _UrdfRobot__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_UrdfRobot(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _UrdfRobot__callbacks = {
...
static rosidl_message_type_support_t _UrdfRobot__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_UrdfRobot__callbacks,
...
{
  return &webots_ros2_msgs::msg::typesupport_fastrtps_cpp::_UrdfRobot__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, webots_ros2_msgs, msg, UrdfRobot)() {
  return &webots_ros2_msgs::msg::typesupport_fastrtps_cpp::_UrdfRobot__handle;
}
