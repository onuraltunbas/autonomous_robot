...
#include "webots_ros2_msgs/msg/detail/float_stamped__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = webots_ros2_msgs::msg::FloatStamped;
    is_plain =
      (
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_webots_ros2_msgs
max_serialized_size_key_FloatStamped(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
{
  auto typed_message =
    static_cast<const webots_ros2_msgs::msg::FloatStamped *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<webots_ros2_msgs::msg::FloatStamped *>(
    untyped_ros_message);
...
{
  return &webots_ros2_msgs::msg::typesupport_fastrtps_cpp::_FloatStamped__handle;
}
