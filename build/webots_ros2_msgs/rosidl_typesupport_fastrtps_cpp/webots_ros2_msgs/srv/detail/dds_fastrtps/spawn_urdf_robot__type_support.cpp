...
size_t get_serialized_size_key(
  ...
  size_t current_alignment);
size_t
max_serialized_size_key_UrdfRobot(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment);
}  // namespace typesupport_fastrtps_cpp
...
{
  // Member: robot
  webots_ros2_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize_key(
    ros_message.robot,
    cdr);
  ...
  size_t current_alignment)
{
  ...
  // Member: robot
  current_alignment +=
    webots_ros2_msgs::msg::typesupport_fastrtps_cpp::get_serialized_size_key(
    ros_message.robot, current_alignment);
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_webots_ros2_msgs
max_serialized_size_key_SpawnUrdfRobot_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // Member: robot
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        webots_ros2_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_key_UrdfRobot(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_webots_ros2_msgs
max_serialized_size_key_SpawnUrdfRobot_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
// functions for webots_ros2_msgs::srv::SpawnUrdfRobot_Request already declared above

// functions for webots_ros2_msgs::srv::SpawnUrdfRobot_Response already declared above
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_webots_ros2_msgs
cdr_serialize(
  const webots_ros2_msgs::srv::SpawnUrdfRobot_Event & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: info
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  webots_ros2_msgs::srv::SpawnUrdfRobot_Event & ros_message)
{
  // Member: info
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_webots_ros2_msgs
max_serialized_size_SpawnUrdfRobot_Event(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // Member: request
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        webots_ros2_msgs::srv::typesupport_fastrtps_cpp::max_serialized_size_SpawnUrdfRobot_Request(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  // Member: response
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        webots_ros2_msgs::srv::typesupport_fastrtps_cpp::max_serialized_size_SpawnUrdfRobot_Response(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = webots_ros2_msgs::srv::SpawnUrdfRobot_Event;
    is_plain =
      (
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_webots_ros2_msgs
max_serialized_size_key_SpawnUrdfRobot_Event(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // Member: request
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        webots_ros2_msgs::srv::typesupport_fastrtps_cpp::max_serialized_size_key_SpawnUrdfRobot_Request(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  // Member: response
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        webots_ros2_msgs::srv::typesupport_fastrtps_cpp::max_serialized_size_key_SpawnUrdfRobot_Response(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
...
{
  auto typed_message =
    static_cast<const webots_ros2_msgs::srv::SpawnUrdfRobot_Event *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<webots_ros2_msgs::srv::SpawnUrdfRobot_Event *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _SpawnUrdfRobot_Event__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const webots_ros2_msgs::srv::SpawnUrdfRobot_Event *>(
...
static size_t _SpawnUrdfRobot_Event__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_SpawnUrdfRobot_Event(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _SpawnUrdfRobot_Event__callbacks = {
  "webots_ros2_msgs::srv",
...
static rosidl_message_type_support_t _SpawnUrdfRobot_Event__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_SpawnUrdfRobot_Event__callbacks,
  get_message_typesupport_handle_function,
...
{
  return &webots_ros2_msgs::srv::typesupport_fastrtps_cpp::_SpawnUrdfRobot_Event__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, webots_ros2_msgs, srv, SpawnUrdfRobot_Event)() {
  return &webots_ros2_msgs::srv::typesupport_fastrtps_cpp::_SpawnUrdfRobot_Event__handle;
}
...
static const rosidl_service_type_support_t _SpawnUrdfRobot__handle{
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_SpawnUrdfRobot__callbacks,
  get_service_typesupport_handle_function,
  ::rosidl_typesupport_fastrtps_cpp::get_message_type_support_handle<webots_ros2_msgs::srv::SpawnUrdfRobot_Request>(),
  ::rosidl_typesupport_fastrtps_cpp::get_message_type_support_handle<webots_ros2_msgs::srv::SpawnUrdfRobot_Response>(),
  ::rosidl_typesupport_fastrtps_cpp::get_message_type_support_handle<webots_ros2_msgs::srv::SpawnUrdfRobot_Event>(),
