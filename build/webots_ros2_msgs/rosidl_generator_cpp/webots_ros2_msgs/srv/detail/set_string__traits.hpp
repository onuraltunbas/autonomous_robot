...
template<typename T, std::enable_if_t<std::is_same_v<std::decay_t<T>, webots_ros2_msgs::srv::SetString_Request>, int> = 0>
...
template<>
constexpr const char * data_type<webots_ros2_msgs::srv::SetString_Request>()
{
  return "webots_ros2_msgs::srv::SetString_Request";
}

template<>
constexpr const char * name<webots_ros2_msgs::srv::SetString_Request>()
{
  return "webots_ros2_msgs/srv/SetString_Request";
}
...
template<>
struct MessageTraits<webots_ros2_msgs::srv::SetString_Request>
{
...
template<typename T, std::enable_if_t<std::is_same_v<std::decay_t<T>, webots_ros2_msgs::srv::SetString_Response>, int> = 0>
constexpr auto as_tuple_ref(T && msg)
{
...
template<>
constexpr const char * data_type<webots_ros2_msgs::srv::SetString_Response>()
{
  return "webots_ros2_msgs::srv::SetString_Response";
}

template<>
constexpr const char * name<webots_ros2_msgs::srv::SetString_Response>()
{
  return "webots_ros2_msgs/srv/SetString_Response";
}
...
template<>
struct MessageTraits<webots_ros2_msgs::srv::SetString_Response>
{
  static constexpr std::size_t member_count = 1;
  static constexpr std::array<std::string_view, member_count> member_names = {
    "success",
...
inline std::string to_yaml(const SetString_Event & msg, bool use_flow_style = false)
{
  std::ostringstream out;
  if (use_flow_style) {
    to_flow_style_yaml(msg, out);
...
template<typename T, std::enable_if_t<std::is_same_v<std::decay_t<T>, webots_ros2_msgs::srv::SetString_Event>, int> = 0>
constexpr auto as_tuple_ref(T && msg)
{
...
template<>
constexpr const char * data_type<webots_ros2_msgs::srv::SetString_Event>()
{
  return "webots_ros2_msgs::srv::SetString_Event";
}

template<>
constexpr const char * name<webots_ros2_msgs::srv::SetString_Event>()
{
  return "webots_ros2_msgs/srv/SetString_Event";
}

template<>
struct has_fixed_size<webots_ros2_msgs::srv::SetString_Event>
  : std::integral_constant<bool, false> {};

template<>
struct has_bounded_size<webots_ros2_msgs::srv::SetString_Event>
  : std::integral_constant<bool, has_bounded_size<service_msgs::msg::ServiceEventInfo>::value && has_bounded_size<webots_ros2_msgs::srv::SetString_Request>::value && has_bounded_size<webots_ros2_msgs::srv::SetString_Response>::value> {};

template<>
struct is_message<webots_ros2_msgs::srv::SetString_Event>
  : std::true_type {};

template<>
struct MessageTraits<webots_ros2_msgs::srv::SetString_Event>
{
...
template<>
constexpr const char * data_type<webots_ros2_msgs::srv::SetString>()
{
  return "webots_ros2_msgs::srv::SetString";
}

template<>
constexpr const char * name<webots_ros2_msgs::srv::SetString>()
{
  return "webots_ros2_msgs/srv/SetString";
}
