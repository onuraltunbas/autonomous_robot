...
template<typename T, std::enable_if_t<std::is_same_v<std::decay_t<T>, webots_ros2_msgs::srv::EmitterSendString_Request>, int> = 0>
...
template<>
constexpr const char * data_type<webots_ros2_msgs::srv::EmitterSendString_Request>()
{
  return "webots_ros2_msgs::srv::EmitterSendString_Request";
}

template<>
constexpr const char * name<webots_ros2_msgs::srv::EmitterSendString_Request>()
{
  return "webots_ros2_msgs/srv/EmitterSendString_Request";
}
...
template<>
struct MessageTraits<webots_ros2_msgs::srv::EmitterSendString_Request>
{
...
template<typename T, std::enable_if_t<std::is_same_v<std::decay_t<T>, webots_ros2_msgs::srv::EmitterSendString_Response>, int> = 0>
constexpr auto as_tuple_ref(T && msg)
{
...
template<>
constexpr const char * data_type<webots_ros2_msgs::srv::EmitterSendString_Response>()
{
  return "webots_ros2_msgs::srv::EmitterSendString_Response";
}

template<>
constexpr const char * name<webots_ros2_msgs::srv::EmitterSendString_Response>()
{
  return "webots_ros2_msgs/srv/EmitterSendString_Response";
}
...
template<>
struct MessageTraits<webots_ros2_msgs::srv::EmitterSendString_Response>
{
  static constexpr std::size_t member_count = 1;
  static constexpr std::array<std::string_view, member_count> member_names = {
    "result",
...
template<typename T, std::enable_if_t<std::is_same_v<std::decay_t<T>, webots_ros2_msgs::srv::EmitterSendString_Event>, int> = 0>
constexpr auto as_tuple_ref(T && msg)
{
...
template<>
constexpr const char * data_type<webots_ros2_msgs::srv::EmitterSendString_Event>()
{
  return "webots_ros2_msgs::srv::EmitterSendString_Event";
}

template<>
constexpr const char * name<webots_ros2_msgs::srv::EmitterSendString_Event>()
{
  return "webots_ros2_msgs/srv/EmitterSendString_Event";
}
...
template<>
struct MessageTraits<webots_ros2_msgs::srv::EmitterSendString_Event>
{
...
template<>
constexpr const char * data_type<webots_ros2_msgs::srv::EmitterSendString>()
{
  return "webots_ros2_msgs::srv::EmitterSendString";
}

template<>
constexpr const char * name<webots_ros2_msgs::srv::EmitterSendString>()
{
  return "webots_ros2_msgs/srv/EmitterSendString";
}
