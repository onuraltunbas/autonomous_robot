...
bool webots_ros2_msgs__msg__urdf_robot__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("webots_ros2_msgs.msg._urdf_robot", (char *)PyUnicode_1BYTE_DATA(module_attr), 32) == 0);
    assert(strncmp("UrdfRobot", (char *)PyUnicode_1BYTE_DATA(name_attr), 9) == 0);
