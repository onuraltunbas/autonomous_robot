...
bool webots_ros2_msgs__srv__get_bool__request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("webots_ros2_msgs.srv._get_bool", (char *)PyUnicode_1BYTE_DATA(module_attr), 30) == 0);
    assert(strncmp("GetBool_Request", (char *)PyUnicode_1BYTE_DATA(name_attr), 15) == 0);
...
bool webots_ros2_msgs__srv__get_bool__response__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    // PyUnicode_1BYTE_DATA is just a cast
    assert(strncmp("webots_ros2_msgs.srv._get_bool", (char *)PyUnicode_1BYTE_DATA(module_attr), 30) == 0);
    assert(strncmp("GetBool_Response", (char *)PyUnicode_1BYTE_DATA(name_attr), 16) == 0);
...
ROSIDL_GENERATOR_C_EXPORT
bool webots_ros2_msgs__srv__get_bool__event__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    PyObject * class_attr = PyObject_GetAttrString(_pymsg, "__class__");
    ...
    // PyUnicode_1BYTE_DATA is just a cast
    assert(strncmp("webots_ros2_msgs.srv._get_bool", (char *)PyUnicode_1BYTE_DATA(module_attr), 30) == 0);
    assert(strncmp("GetBool_Event", (char *)PyUnicode_1BYTE_DATA(name_attr), 13) == 0);

    Py_DECREF(module_attr);
    Py_DECREF(name_attr);
    Py_DECREF(class_attr);
  }
  webots_ros2_msgs__srv__GetBool_Event * ros_message = _ros_message;
  {  // info
  ...
  {  // request
    ...
    if (!webots_ros2_msgs__srv__GetBool_Request__Sequence__init(&(ros_message->request), size)) {
      PyErr_SetString(PyExc_RuntimeError, "unable to create webots_ros2_msgs__srv__GetBool_Request__Sequence ros_message");
      Py_DECREF(seq_field);
      Py_DECREF(field);
      return false;
    }
    webots_ros2_msgs__srv__GetBool_Request * dest = ros_message->request.data;
    for (Py_ssize_t i = 0; i < size; ++i) {
      if (!webots_ros2_msgs__srv__get_bool__request__convert_from_py(PySequence_Fast_GET_ITEM(seq_field, i), &dest[i])) {
        Py_DECREF(seq_field);
        Py_DECREF(field);
        return false;
      }
  ...
  {  // response
    ...
    if (!webots_ros2_msgs__srv__GetBool_Response__Sequence__init(&(ros_message->response), size)) {
      PyErr_SetString(PyExc_RuntimeError, "unable to create webots_ros2_msgs__srv__GetBool_Response__Sequence ros_message");
      Py_DECREF(seq_field);
      Py_DECREF(field);
      return false;
    }
    webots_ros2_msgs__srv__GetBool_Response * dest = ros_message->response.data;
    for (Py_ssize_t i = 0; i < size; ++i) {
      if (!webots_ros2_msgs__srv__get_bool__response__convert_from_py(PySequence_Fast_GET_ITEM(seq_field, i), &dest[i])) {
        Py_DECREF(seq_field);
        Py_DECREF(field);
        return false;
      }
...
ROSIDL_GENERATOR_C_EXPORT
PyObject * webots_ros2_msgs__srv__get_bool__event__convert_to_py(void * raw_ros_message)
{
  /* NOTE(esteve): Call constructor of GetBool_Event */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("webots_ros2_msgs.srv._get_bool");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "GetBool_Event");
    assert(pymessage_class);
    Py_DECREF(pymessage_module);
    _pymessage = PyObject_CallObject(pymessage_class, NULL);
    Py_DECREF(pymessage_class);
  ...
  webots_ros2_msgs__srv__GetBool_Event * ros_message = (webots_ros2_msgs__srv__GetBool_Event *)raw_ros_message;
  {  // info
    PyObject * field = NULL;
  ...
  {  // request
    ...
    for (size_t i = 0; i < size; ++i) {
      ...
      PyObject * pyitem = webots_ros2_msgs__srv__get_bool__request__convert_to_py(item);
      if (!pyitem) {
        Py_DECREF(field);
        return NULL;
      }
  ...
  {  // response
    ...
    for (size_t i = 0; i < size; ++i) {
      ...
      PyObject * pyitem = webots_ros2_msgs__srv__get_bool__response__convert_to_py(item);
      if (!pyitem) {
        Py_DECREF(field);
        return NULL;
      }
